...
<template>
  <div class="relative">
    ...
    <div :class="['w-64 bg-white rounded-lg border p-4 fixed top-0 left-0 h-full z-40 transition-transform transform', isFilterVisible ? 'translate-x-0' : '-translate-x-full', 'lg:relative lg:translate-x-0 lg:h-auto lg:top-auto lg:left-auto lg:z-auto']">
